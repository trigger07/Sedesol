  ...
  */
  ...
  ParsleyUI.prototype = {
    ...
    _manageClassHandler: function (fieldInstance) {
      ...
      return fieldInstance.$element.parent().parent().children();
    },
    _insertErrorWrapper: function (fieldInstance) {
      ...
      return 'undefined' === typeof fieldInstance.options.multiple ? fieldInstance.$element.after(fieldInstance._ui.$errorsWrapper) : fieldInstance.$element.parent().parent().children().last().after(fieldInstance._ui.$errorsWrapper);
    },
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
    defaultMessage: "Este valor parece no ser v&aacute;lido.",
  type: {
      email: "El valor debe ser un email v&aacute;lido.",
      url:          "Este valor debe ser una url v&aacute;lida.",
      number:       "Este valor debe ser un n&uacute;mero con tres decimales.",
    integer:      "Este valor debe ser un entero.",
    digits:       "Este valor debe ser digitos.",
    alphanum:     "Este valor debe ser alfanumérico."
  },
  notblank:       "Este valor no debe quedar vacío.",
  required:       "El campo es requerido.",
    pattern:        "Este valor parece no ser v&aacute;lido.",
  min:            "Este valor debe ser mayor o igual que %s.",
  max:            "Este valor debe ser menor o igual que %s.",
  range:          "Este valor debe estar entre %s y %s.",
  minlength:      "Este valor es muy corto. Debe tener %s caracteres.",
  maxlength:      "Este valor es muy largo. Debe tener %s caracteres.",
  length:         "El tamaño de este valor no es valido. Debe tener entre %s y %s caracteres.",
  mincheck:       "Debe de seleccionar al menos %s opciones.",
